...
namespace PoeStashSearch.Data.Models {
	public record MiscellaneousCriteria {
		public bool? IsCorrupted { get; init; }

		public bool? IsIdentified { get; init; }

		public decimal? ItemLevelMaximum { get; init; }

		public decimal? ItemLevelMinimum { get; init; }

		public decimal? QualityMaximum { get; init; }

		public decimal? QualityMinimum { get; init; }
